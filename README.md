...
If I had to pick an order to do things in, I’d say this is a good approach:
...
4.	If you’re hooked at this point, you can keep going with more [FreeCodeCamp](https://www.freecodecamp.org/learn) courses or [Udemy](https://www.udemy.com/) ones and try to build your own projects (best way to learn) and add them to a GitHub portfolio (best way to show what you’ve learned, and get a job), or look at a [Springboard course](https://springboardcourses.ie/login) if wanting to get a formal qualification
